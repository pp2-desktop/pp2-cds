...
env.Program('xx', ['ws_examples.cpp', 'vs_room.cpp', 'cd_user.cpp', 'vs_room_md.cpp', 'cd_handler_md.cpp', 'json11.cpp', 'handler/join_room_req.cpp', 'handler/leave_room_req.cpp'])
